...
class Issue(models.Model):
    ...
    assignee_user = models.ForeignKey(to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='assignee', null=True, blank=True, default=None)
...
class Comment(models.Model):
    ...
    description = models.CharField(max_length=800)
    author_user = models.ForeignKey(to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE, null=True, blank=True, default=None)
    issue = models.ForeignKey(Issue, on_delete=models.CASCADE, null=True, blank=True, default=None, related_name='comment')
    created_time = models.DateTimeField(auto_now_add=True) 
